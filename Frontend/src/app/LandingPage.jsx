          ...
          <div className="col-span-1 flex flex-col justify-center z-20 h-full relative">
            ...
            <h1 className="text-[10vw] lg:text-[5.8vw] font-black leading-[0.85] tracking-tighter text-slate-900 relative z-20">
              ...
              <div className="overflow-hidden pb-4">
                <motion.div custom={2} initial="hidden" animate="visible" variants={textReveal} className="flex items-center gap-4 lg:gap-8">
                  <span className="text-transparent bg-clip-text bg-gradient-to-br from-[#008078] to-pink-600">AMAL FOODS?</span>
                </motion.div>
              </div>
            </h1>
            ...
            <div className="overflow-hidden mt-4 lg:mt-6 max-w-xl">
              <motion.p custom={3} initial="hidden" animate="visible" variants={textReveal} className="text-base lg:text-lg text-slate-600 font-light leading-relaxed">
                Amal Foods is a next-generation food delivery platform built with a mission to create fairness and transparency in the food ecosystem. Unlike traditional platforms, we operate on a lifetime 0% commission model, ensuring that restaurant partners keep every hard-earned penny of their revenue.
              </motion.p>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-light max-w-lg">
              Unlike traditional delivery apps that squeeze restaurant margins, Amal Foods works on a lifetime 0% commission model. We believe in creating a balanced, fair, and growth-oriented food ecosystem.
            </p>
            <div className="pt-2">
              <button
                onClick={() => setIsAboutOpen(true)}
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-600 font-light leading-relaxed">
                Starting our journey from the progressive landscape of <strong>Telangana</strong>, Amal Foods is engineered to scale across India, specifically focusing on empowering Tier-2 and Tier-3 cities.
              </p>
            </div>
            ...
            >
              ...
              <div className="relative z-10 flex-1 flex items-center justify-center py-4 overflow-hidden select-none pointer-events-none">
                <img 
                  ...
                  alt="Amal Foods Operational Map" 
        ...
        {isAboutOpen && (
          ...
          >
            ...
            <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 md:py-20 lg:px-20 flex flex-col gap-12 md:gap-20">
              ...
              <div className="max-w-3xl space-y-6">
                ...
                <p className="text-xl text-slate-600 font-light leading-relaxed">
                  Amal Foods is built with a mission to create a sustainable, transparent, and balanced environment for both food merchants and consumers across India.
                </p>
              </div>
              ...
              <div className="bg-slate-900 text-white rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden shadow-2xl shrink-0">
                ...
                <div className="relative z-10 space-y-6">
                  <p className="text-2xl md:text-3xl lg:text-4xl font-light leading-relaxed italic text-slate-100 max-w-4xl">
                    "Amal Foods isn’t just a food delivery app—it’s a movement towards fair business, trust, and transparency."
                  </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                <div className="group bg-white border border-slate-200/60 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-pink-500/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      By offering transparent pricing, Amal Foods ensures customers pay genuine prices without hidden markups. We are building long-term relationships of trust with both restaurants and consumers.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3">
                ...
                <div className="group bg-white border border-slate-200/60 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-pink-500/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      Amal Foods is starting its journey from Telangana, with a strategic focus on expanding across Tier 2 and Tier 3 cities in India. We aim to empower local businesses in these growing regions and integrate them into the digital market.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3">
                ...
                <div className="group bg-white border border-slate-200/60 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-pink-500/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      Amal Foods was founded by two passionate 23-year-old entrepreneurs driven by a vision to revolutionize the food delivery industry and create a more balanced, fair, and growth-oriented platform for all stakeholders.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3">
              ...
              <div className="text-center py-12 md:py-20 border-t border-slate-200/60 flex flex-col items-center gap-6 shrink-0">
                ...
                <p className="text-slate-500 max-w-lg font-light">
                  Support your local neighborhood restaurants. Join Amal Foods today as a customer or partner and help us create a fair ecosystem.
                </p>
            ...
            <footer className="bg-slate-50 border-t border-slate-200/50 py-8 text-center text-xs text-slate-400 font-medium shrink-0">
              <p>© 2026 {APP_CONFIG?.NAME || "Amal Foods"} Technologies Inc. All rights reserved.</p>
            </footer>
          </motion.div>
        )}
            ...
            <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 md:py-20 lg:px-20 flex flex-col gap-12 md:gap-20">
              ...
              <div className="max-w-4xl space-y-6 text-center mx-auto mb-4">
                ...
                <p className="text-xl text-slate-700 font-light leading-relaxed max-w-3xl mx-auto">
                  Say goodbye to standard 25%-30% commissions that wipe out restaurant profit margins. With Amal Foods, you gain access to a powerful digital ordering system on a <strong>lifetime 0% commission model</strong>.
                </p>
              </div>
                  ...
                  <div className="w-full max-w-[380px] h-[250px] bg-slate-900 border-4 border-slate-700 rounded-2xl shadow-2xl p-4 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 gap-3 py-2 flex-1 items-center">
                      <div className="bg-slate-950 border border-slate-800 rounded-lg p-2.5 text-center">
                        <div className="text-[8px] text-slate-500 font-bold uppercase tracking-wider">With Amal Foods</div>
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                <div className="group bg-white/80 border border-slate-200/40 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-[#008078]/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between shadow-sm">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      Say goodbye to frustrating weekly payout cycles that lock up your operating capital. Amal Foods processes bank settlements daily, keeping your cash flow running smoothly.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-200/50 flex items-center gap-3">
              ...
              <div id="partner-lead-form" className="py-12 md:py-20 border-t border-slate-200/40 shrink-0 max-w-3xl mx-auto w-full">
                <div className="text-center mb-10">
                  ...
                  <p className="text-slate-600 max-w-lg font-light text-sm md:text-base mx-auto mt-3">
                    Fill out the form below to register your interest, and our onboarding team will contact you to set up your restaurant on Amal Foods.
                  </p>
                </div>
                ...
                {leadSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600 max-w-md mx-auto">
                      Thank you for choosing Amal Foods. Our onboarding representative will get in touch with you shortly to finalize your registration.
                    </p>
                    <button
            ...
            <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 md:py-20 lg:px-20 flex flex-col gap-12 md:gap-20">
              ...
              <div className="max-w-4xl space-y-6 text-center mx-auto mb-4">
                ...
                <p className="text-xl text-slate-400 font-light leading-relaxed max-w-3xl mx-auto">
                  Join the elite squad of Amal Foods Captains. Secure the most competitive distance-based payout structure, absolute route clarity, weekly settlements, and <strong>keep 100% of your customer tips</strong>.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                <div className="group bg-slate-900/40 border border-slate-800/80 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-pink-500/5 hover:border-pink-500/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-400 font-light leading-relaxed">
                      Every single rupee that a grateful customer tips you belongs entirely to you. Amal Foods takes zero cuts from your extra rewards. Honest payouts, guaranteed.
                    </p>
                  </div>
                ...
                <div className="group bg-slate-900/40 border border-slate-800/80 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-pink-500/5 hover:border-pink-500/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-400 font-light leading-relaxed">
                      Never wait weeks to enjoy your hard-earned rewards. Amal Foods settles your total earnings straight into your active digital wallet every single week, cleanly and securely.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-800/60 flex items-center gap-3">
                    <Map className="w-4 h-4 text-[#008078]" />
              ...
              <div className="text-center py-12 md:py-20 border-t border-slate-800/80 flex flex-col items-center gap-6 shrink-0">
                <h3 className="text-3xl md:text-4xl font-black text-white">Start Earning with Amal Foods</h3>
